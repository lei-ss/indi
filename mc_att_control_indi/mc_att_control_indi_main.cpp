    ...
    _ts_opt_recovery(nullptr)
{
    ...
    indi.g1 = {STABILIZATION_INDI_G1_P, STABILIZATION_INDI_G1_Q, STABILIZATION_INDI_G1_R};
    ...
    indi.est.g2 = STABILIZATION_INDI_G2_R / INDI_EST_SCALE;
    indi.est.mu = STABILIZATION_INDI_ADAPTIVE_MU;
    //INDI end
...
MulticopterAttitudeControl::stabilization_indi_run(bool in_flight __attribute__((unused)), bool rate_control,float dt)
{
  ...
  _att_control(AXIS_INDEX_YAW) = stabilization_att_indi_cmd[COMMAND_YAW] / 4500.0f;
    ...
    //warnx("indi_p:%d",stabilization_att_indi_cmd[COMMAND_ROLL]);
    //warnx("indi_q:%d",stabilization_att_indi_cmd[COMMAND_PITCH]);
    //warnx("indi_r:%d",stabilization_att_indi_cmd[COMMAND_YAW]);
}
