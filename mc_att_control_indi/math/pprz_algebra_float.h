...
#include "../include/message_pragmas.h"
...
#define FLOAT_VECT2_ZERO(_v) VECT2_ASSIGN(_v, 0.0f, 0.0f)
...
#define FLOAT_VECT3_ZERO(_v) VECT3_ASSIGN(_v, 0.0f, 0.0f, 0.0f)
...
#define FLOAT_EULERS_ZERO(_e) EULERS_ASSIGN(_e, 0.0f, 0.0f, 0.0f);
